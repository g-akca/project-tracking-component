  ...
  return (
    <main className="flex flex-col gap-8 tablet:gap-16 desktop:mt-10">
      ...
      <div className="flex gap-4 tablet:gap-6 items-center">
        <button type="button" className="bg-red-400 text-white px-6 tablet:px-8 py-2 tablet:py-4 h-10 tablet:h-12 tablet:w-46 rounded-[5px] font-bold tracking-[1px] uppercase cursor-pointer transition-all duration-300 hover:bg-red-350">Schedule a Demo</button>
